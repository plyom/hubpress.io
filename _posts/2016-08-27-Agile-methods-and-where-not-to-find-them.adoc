...
But we have to remind us that we still have the left part, the important one, of the list to be reaaaly good at, otherwise we would not be Agile, we would just not do boring stuff.
